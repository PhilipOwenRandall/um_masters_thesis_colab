# Scrip For Christian - Experiment C2_hidden
# C2_hidden trains the model with the randomly distributed variables, the subgroup noise and the sample identifiers
...
experimentc2_hidden <- function(n, 
                                n.test, 
                                d, 
                                prop,
                                noise)
...
simulation_procedure <- function(d) {
  ...
  n.test <- 1000
  noise <- 0.5
  data <- experimentc2_hidden(n,          # The name of this function needs to be changed.
                              n.test,
                              d=d,
                              prop = 0.5,
                              noise)
...
save.image(paste("Experiment_C2_hidden_RWTH.RData",sep=""))
