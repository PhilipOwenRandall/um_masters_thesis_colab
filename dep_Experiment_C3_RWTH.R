# Scrip For Christian - Experiment C3
# C3 now hides from the model randomly distributed variables, the subgroup noise and the sample identifiers
...
simulation_procedure <- function(d) {
  ...
  n.test <- 1000
  noise <- 0.5
  data <- experimentc3(n,          # The name of this function needs to be changed.
                       n.test,
                       d=d,
                       prop = 0.5,
                       noise)
...
save.image(paste("Experiment_C3_RWTH.RData",sep=""))
